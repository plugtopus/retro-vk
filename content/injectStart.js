...
watchVar('Photoview', function(Photoview) {
    if (!Photoview.createLayer.oldvk) {
        ...
        Photoview.createLayer = function() {
            ...
            var pv_switch_wrap = ce('div', {
                id: 'pv_switch_wrap',
                innerHTML: '<div id="pv_switch"></div>'
            });
        ...
        if (!Photoview.doShow.oldvk) {
            ...
            Photoview.doShow = function() {
                ...
                if (geByClass1('pv_author_block')) {
                    ...
                    var date_wrap = ce('div', {
                        innerHTML: cur.pvCurPhoto.date
                    });
                    ...
                    cur.pvBottomLike.appendChild(geByClass1('like_btns'))
                }
...
watchVar('Emoji', function(Emoji) {
    ...
    window.postMessage({
        type: "VK_EMOJI",
        text: {
            emoji: Emoji.getRecentEmojiSorted(),
            html: emoji
        }
    }, "*");
});
...
function _bind(variable, func, before, after) {
